...
<h3 style="font-family: Tangerine, cursive; color: black; font-size: 40px; text-align:center; font-weight: 900;">All Fetilizer</h3>         
        ...
        document.addEventListener('DOMContentLoaded', function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "Afertilizer.php"; // Redirect to the cart page
                }
            });
        });
