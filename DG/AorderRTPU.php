...
$status = isset($_GET['status']) ? $_GET['status'] : 'Ready-To-Pick-Up';
...
<div class="tablist">
    ...
    <button class="tab-button active" onclick="window.location.href='AorderRTPU.php'">Ready To Pick Up</button>
                            ...
                            <td class="text-center">
                                ...
                                switch ($row['status']) {
                                    ...
                                    case 'Ready-To-Pick-Up':
                                        echo "<span class='badge badge-light'>Ready-To-Pick-Up</span>";
                                        break;
                                    case 'Completed':
