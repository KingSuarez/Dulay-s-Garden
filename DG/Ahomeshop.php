...
<div id="Allproductsearch">
<h3 style="font-weight: 900;">All Products</h3>
<form id="searchForm" method="GET" action="Ahomeshop.php" style="text-align: right;">
        ...
        if ($show_products->rowCount() > 0) {
            while ($fetch_products = $show_products->fetch(PDO::FETCH_ASSOC)) {
                ?>
                        <div class="SpecificProductCard" data-stock="<?= $fetch_products['stock']; ?>">
                            <form action="" method="POST">
                                ...
                                <h1 style="font-size: 24px; font-family:poppins; font-weight:bolder; text-transform: capitalize;" class="pname" name="pname"><?= $fetch_products['pname'] ?></h1>
                ...
                <?php
                    ...
                    echo '<p class="empty" style="font-size:20px;"><b>No Found Product!</b></p>';
                }
                ?>
</div>
</div>
...
<script>
        document.getElementById('searchForm').addEventListener('submit', function(event) {
            ...
            window.location.href = action + '?' + queryString + '#Allproductsearch';
        });
    </script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "Ahomeshop.php"; // Redirect to the cart page
                }
            });
        });
...
<script>
    ...
    <!-- <script>
        ...
        document.getElementById('searchForm').addEventListener('submit', function(event) {
            ...
            var productCards = document.querySelectorAll('.SpecificProductCard');
            
            productCards.forEach(function(card) {
                var productName = card.querySelector('.pname').textContent.toLowerCase();
