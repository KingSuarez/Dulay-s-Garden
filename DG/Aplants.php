...
<h3 style="font-family: Tangerine, cursive; color: black; font-size: 40px; text-align:center; font-weight: 900;">All Plants</h3>         
...
<?php
    ...
    echo '<p class="empty">No products found in the "Plant" category!</p>';
}
?>
