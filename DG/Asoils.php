...
<h3 style="font-family: Tangerine, cursive; color: black; font-size: 40px; text-align:center; font-weight: 900;">All Soil</h3>         
<form method="GET" action="" style="text-align: right;">
  ...
  <?php
// Search Filter
$sql = "SELECT * FROM `products` WHERE category = 'Soil'";
