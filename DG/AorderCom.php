...
<div class="tablist">
    <button class="tab-button" onclick="window.location.href='Aorder.php'">Pending</button>
    ...
    <button class="tab-button active" onclick="window.location.href='AorderCom.php'">Completed</button>
...
$(document).on('click', '.pay_order', function() {
    ...
    if (confirm('Mark this order as paid?')) {
        window.location.href = 'order_actions.php?id=' + orderId;
    }
});

// Optionally, handle the status messages after redirection
$(document).ready(function() {
    ...
    if (status === 'success') {
        ...
        alert('Failed to mark the order as paid.');
