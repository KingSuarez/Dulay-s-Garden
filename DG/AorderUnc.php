...
$status = isset($_GET['status']) ? $_GET['status'] : 'Unclaim';
...
<div class="tablist">
    ...
    <button class="tab-button active" onclick="window.location.href='AorderUnc.php'">Unclaimed</button>
</div>
                            ...
                            <td class="text-center">
                                ...
                                switch ($row['status']) {
                                    ...
                                    case 'Cancelled':
                                        ...
                                        break;
                                    case 'Unclaim':
                                        echo "<span class='badge badge-danger'>Unclaim</span>";
                                        break;
                                }
                                ?>
                            </td>
