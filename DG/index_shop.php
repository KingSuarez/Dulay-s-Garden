...
<div class="CategoriesSection_inner">
    ...
    <p><a href="index_pot.php"><button>View Pots</button></a></p>
    </div>
...
<div id="find">
<h3 style="font-weight: bold;">All Products</h3>
<form id="searchForm" method="GET" action="index_shop.php" style="text-align: right;">
...
<script>
        document.getElementById('searchForm').addEventListener('submit', function(event) {
            ...
            window.location.href = action + '?' + queryString + '#find';
        });
    </script>
